...
CXXFLAGS += -DMODULE=\"$(MODULE)\"
ASMFLAGS += -DMODULE=\"$(MODULE)\"


ifneq ($(COMPILER_VERSION),) 
BUILD_DIR = $(OUT_DIR)/$(TARGET_TUPLE)/$(COMPILER)-$(COMPILER_VERSION)/$(BUILD_TYPE)/build
EXE_DIR   = $(OUT_DIR)/$(TARGET_TUPLE)/$(COMPILER)-$(COMPILER_VERSION)/$(BUILD_TYPE)/bin
SO_DIR    = $(OUT_DIR)/$(TARGET_TUPLE)/$(COMPILER)-$(COMPILER_VERSION)/$(BUILD_TYPE)/lib
A_DIR     = $(OUT_DIR)/$(TARGET_TUPLE)/$(COMPILER)-$(COMPILER_VERSION)/$(BUILD_TYPE)/lib

else
BUILD_DIR = $(OUT_DIR)/$(TARGET_TUPLE)/$(COMPILER)/$(BUILD_TYPE)/build
EXE_DIR   = $(OUT_DIR)/$(TARGET_TUPLE)/$(COMPILER)/$(BUILD_TYPE)/bin
SO_DIR    = $(OUT_DIR)/$(TARGET_TUPLE)/$(COMPILER)/$(BUILD_TYPE)/lib
A_DIR     = $(OUT_DIR)/$(TARGET_TUPLE)/$(COMPILER)/$(BUILD_TYPE)/lib
endif

OUT_EXE   = $(EXE_DIR)/$(EXEPRE)$(MODULE)$(EXESUF) 
OUT_SO    = $(SO_DIR)/$(SOPRE)$(MODULE)$(SOSUF) 
OUT_A     = $(A_DIR)/$(APRE)$(MODULE)$(ASUF) 
